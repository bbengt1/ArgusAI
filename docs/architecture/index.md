...
- [Architecture Document](#table-of-contents)
  ...
  - [Phase 15 Additions](./phase-15-additions.md)
    - [Phase 15 Executive Summary](./phase-15-additions.md#phase-15-executive-summary)
    - [Phase 15 Technology Stack Additions](./phase-15-additions.md#phase-15-technology-stack-additions)
    - [Phase 15 Project Structure Additions](./phase-15-additions.md#phase-15-project-structure-additions)
    - [Phase 15 Database Schema Additions](./phase-15-additions.md#phase-15-database-schema-additions)
      - [User Model](./phase-15-additions.md#user-model-p15-21)
      - [Session Model](./phase-15-additions.md#session-model-p15-22)
      - [Event Model Extensions](./phase-15-additions.md#event-model-extensions-p15-53)
    - [Phase 15 Service Architecture](./phase-15-additions.md#phase-15-service-architecture)
      - [Authentication & Session Flow](./phase-15-additions.md#authentication--session-flow-p15-2)
      - [PasswordService](./phase-15-additions.md#passwordservice-p15-24)
      - [SessionService](./phase-15-additions.md#sessionservice-p15-27-p15-28)
      - [RBAC Permissions](./phase-15-additions.md#rbac-permissions-p15-29)
      - [FrameAnnotationService](./phase-15-additions.md#frameannotationservice-p15-52)
    - [Phase 15 API Contracts](./phase-15-additions.md#phase-15-api-contracts)
      - [User Management API](./phase-15-additions.md#user-management-api-p15-23)
      - [Session Management API](./phase-15-additions.md#session-management-api-p15-27)
      - [Multi-Entity Events API](./phase-15-additions.md#multi-entity-events-api-p15-41)
      - [AI Bounding Boxes API](./phase-15-additions.md#ai-bounding-boxes-api-p15-51)
    - [Phase 15 Frontend Architecture](./phase-15-additions.md#phase-15-frontend-architecture)
      - [Entity Modal Virtual Scrolling](./phase-15-additions.md#entity-modal-virtual-scrolling-p15-12)
      - [Settings Form Hook](./phase-15-additions.md#settings-form-hook-p15-32)
      - [Unsaved Changes Warning](./phase-15-additions.md#unsaved-changes-warning-p15-34)
    - [Phase 15 Architecture Decision Records](./phase-15-additions.md#phase-15-architecture-decision-records)
      - [ADR-P15-001: Session-Based Authentication with JWT](./phase-15-additions.md#adr-p15-001-session-based-authentication-with-jwt)
      - [ADR-P15-002: bcrypt with Cost Factor 12](./phase-15-additions.md#adr-p15-002-bcrypt-with-cost-factor-12)
      - [ADR-P15-003: Three-Role RBAC](./phase-15-additions.md#adr-p15-003-three-role-rbac-adminoperatorviewer)
      - [ADR-P15-004: Virtual Scrolling for Entity Events](./phase-15-additions.md#adr-p15-004-virtual-scrolling-for-entity-events)
      - [ADR-P15-005: Explicit Save Pattern for Settings](./phase-15-additions.md#adr-p15-005-explicit-save-pattern-for-settings)
      - [ADR-P15-006: Multi-Entity via Junction Table](./phase-15-additions.md#adr-p15-006-multi-entity-via-entityevent-junction-table)
      - [ADR-P15-007: Provider-Specific Bounding Box Support](./phase-15-additions.md#adr-p15-007-provider-specific-bounding-box-support)
    - [Phase 15 Epic to Architecture Mapping](./phase-15-additions.md#phase-15-epic-to-architecture-mapping)
    - [Phase 15 Performance Considerations](./phase-15-additions.md#phase-15-performance-considerations)
    - [Phase 15 Validation Checklist](./phase-15-additions.md#phase-15-validation-checklist)
